...
import Shannon.Data.Migration (AlreadyHasUpgrade, Migration)
...
import Shannon.Migration (addIndex, addTable, defineMigration, newVersion, setUpgrade)
...
migration :: Migration D1 MySchema AlreadyHasUpgrade
